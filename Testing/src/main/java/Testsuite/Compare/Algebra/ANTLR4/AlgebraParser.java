...
import Testsuite.Compare.Algebra.*;
...
public class AlgebraParser extends GrammaticaBaseVisitor<AlgebraParserElement>{
	...
	public And_Assertion visitParseAssertionList(GrammaticaParser.ParseAssertionListContext ctx) {
		...
		List<GrammaticaParser.AssertionContext> keywords = ctx.assertion();
		
		for(GrammaticaParser.AssertionContext key : keywords) {
	...
	public AntlrArray visitArrayValue(GrammaticaParser.ArrayValueContext ctx) {
		...
		List<GrammaticaParser.Json_valueContext> list = ctx.json_value();
		
		for(GrammaticaParser.Json_valueContext el : list)
	...
	public And_Assertion visitParseAllOf(GrammaticaParser.ParseAllOfContext ctx) {
		List<GrammaticaParser.AssertionContext> list = ctx.assertion();
		And_Assertion and = new And_Assertion();
		
		for(GrammaticaParser.AssertionContext el : list)
	...
	public Enum_Assertion visitParseEnum(GrammaticaParser.ParseEnumContext ctx) { 
		...
		List<GrammaticaParser.Json_valueContext> valueList = ctx.json_value();
		
		//trattare null con classe NullAntlr ?
		for(GrammaticaParser.Json_valueContext value : valueList) {
	...
	public Items_Assertion visitParseOnlyItems(GrammaticaParser.ParseOnlyItemsContext ctx) {
		...
		for(GrammaticaParser.AssertionContext item : list)
